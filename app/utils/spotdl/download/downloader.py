...
from app.utils.spotdl.download.progress_handler import ProgressHandler
from app.utils.spotdl.providers.audio import (
    AudioProvider,
    BandCamp,
    Piped,
    SoundCloud,
...
from app.utils.spotdl.providers.lyrics import AzLyrics, Genius, LyricsProvider, MusixMatch, Synced
from app.utils.spotdl.types.options import DownloaderOptionalOptions, DownloaderOptions
from app.utils.spotdl.types.song import Song
from app.utils.spotdl.utils.archive import Archive
from app.utils.spotdl.utils.config import (
    DOWNLOADER_OPTIONS,
    GlobalConfig,
...
from app.utils.spotdl.utils.ffmpeg import FFmpegError, convert, get_ffmpeg_path
from app.utils.spotdl.utils.formatter import create_file_name
from app.utils.spotdl.utils.lrc import generate_lrc
from app.utils.spotdl.utils.m3u import gen_m3u_files
from app.utils.spotdl.utils.metadata import MetadataError, embed_metadata
from app.utils.spotdl.utils.search import gather_known_songs, reinit_song, songs_from_albums
...
class Downloader:
    ...
    def __init__(
        ...
        # from app.utils.spotdl.types.options.DOWNLOADER_OPTIONS
